namespace BeSafe.Core.Helpers
{
    ...
    public static class Settings
    {
        ...
        private const string savedInstanceState = "savedInstanceState";
        ...
        public static bool SavedInstanceState
        {
            get => AppSettings.GetValueOrDefault(savedInstanceState, boolDefault);
            set => AppSettings.AddOrUpdateValue(savedInstanceState, value);
        }
    }
}
