...
namespace BeSafe.FormsCross.Droid.Services
{
    ...
    public class LocationForegroundService : Service
    {
        ...
        PendingIntent BuildIntentToShowMainActivity()
        {
            ...
            var notificationIntent = new Intent(this,act.Class);
            notificationIntent.SetAction(Constant.ACTION_MAIN_ACTIVITY);
            notificationIntent.SetFlags(ActivityFlags.SingleTop | ActivityFlags.ClearTask);
            notificationIntent.PutExtra(Constant.SERVICE_STARTED_KEY, true);
